...
To Do:
	Fix double confirmation box upon deletion of Pin.
	Only allow the specific owner of a Pin to Edit or Delete that Pin. See Mackenzie Child's 006: Setup User Authentication with Devise Youtube tutorial.
